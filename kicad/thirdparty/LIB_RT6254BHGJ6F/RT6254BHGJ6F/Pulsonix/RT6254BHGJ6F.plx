...
(library Library_1
	...
	(patternDef "SOT95P280X100-6N" (originalName "SOT95P280X100-6N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.8 0.498) (pt 0.15 1.448) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "RT6254BHGJ6F" (originalName "RT6254BHGJ6F") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "BOOT") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://4donline.ihs.com/images/VipMasterIC/IC/RHTK/RHTK-S-A0009164484/RHTK-S-A0009164484-1.pdf?hkey=EF798316E3902B6ED9A73243A3159BB0")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "RT6254BHGJ6F.stp")
