...
//264007/1805047/2.50/21/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TXB0108RGYR" (originalName "TXB0108RGYR")
	...
	(compDef "TXB0108RGYR" (originalName "TXB0108RGYR") (compHeader (numPins 21) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TXB0108RGYR"))
		...
		(attr "Manufacturer_Part_Number" "TXB0108RGYR")
		(attr "Mouser Part Number" "595-TXB0108RGYR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TXB0108RGYR?qs=oFXvjAmG9EjlwpBG6jCg6w%3D%3D")
		(attr "Arrow Part Number" "TXB0108RGYR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/txb0108rgyr/texas-instruments.html?utm_currency=USD&region=nac")
		(attr "Description" "8-Bit Bidirectional Voltage-Level Shifter with Auto Direction Sensing and +/-15-kV ESD Protect")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/txb0108")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "TXB0108RGYR.stp")
